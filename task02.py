...
if __name__ == '__main__':
    ...
    if (len(re.sub(r"[\d+/\-]", "", a)) > 0) or (len(re.sub(r"[\d+/\-]", "", b)) > 0): # Выкинуть из строки все цифры
                                                                                       # и знаки / и -
...
# Результат работы:
# C:\Work\python\dz3\Py3HW02\venv\Scripts\python.exe C:/Work/python/dz3/Py3HW02/task02.py
